...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 07, 2017 at 10:59 PM
...
--
-- Table structure for table `fx21p_assets`
--

CREATE TABLE IF NOT EXISTS `fx21p_assets` (
...
--
-- Dumping data for table `fx21p_assets`
--

INSERT INTO `fx21p_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
(55, 1, 103, 104, 1, 'com_torshop', 'com_torshop', '{}'),
(56, 1, 105, 106, 1, 'com_tortags', 'com_tortags', '{}');

-- --------------------------------------------------------

--
-- Table structure for table `fx21p_associations`
--

CREATE TABLE IF NOT EXISTS `fx21p_associations` (
...
--
-- Table structure for table `fx21p_banners`
--

CREATE TABLE IF NOT EXISTS `fx21p_banners` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `fx21p_banner_clients`
--

CREATE TABLE IF NOT EXISTS `fx21p_banner_clients` (
  `id` int(11) NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Table structure for table `fx21p_banner_tracks`
--

CREATE TABLE IF NOT EXISTS `fx21p_banner_tracks` (
...
--
-- Table structure for table `fx21p_categories`
--

CREATE TABLE IF NOT EXISTS `fx21p_categories` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `fx21p_categories`
--

INSERT INTO `fx21p_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
(1, 0, 0, 0, 11, 0, '', 'system', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{}', '', '', '{}', 335, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(2, 27, 1, 1, 2, 1, 'uncategorised', 'com_content', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 335, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(3, 28, 1, 3, 4, 1, 'uncategorised', 'com_banners', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 335, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(4, 29, 1, 5, 6, 1, 'uncategorised', 'com_contact', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 335, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(5, 30, 1, 7, 8, 1, 'uncategorised', 'com_newsfeeds', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 335, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(7, 32, 1, 9, 10, 1, 'uncategorised', 'com_users', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 335, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1);

-- --------------------------------------------------------

--
-- Table structure for table `fx21p_contact_details`
--

CREATE TABLE IF NOT EXISTS `fx21p_contact_details` (
  `id` int(11) NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `alias` varchar(400) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
...
--
-- Table structure for table `fx21p_content`
--

CREATE TABLE IF NOT EXISTS `fx21p_content` (
...
--
-- Table structure for table `fx21p_contentitem_tag_map`
--

CREATE TABLE IF NOT EXISTS `fx21p_contentitem_tag_map` (
...
--
-- Table structure for table `fx21p_content_frontpage`
--

CREATE TABLE IF NOT EXISTS `fx21p_content_frontpage` (
...
--
-- Table structure for table `fx21p_content_rating`
--

CREATE TABLE IF NOT EXISTS `fx21p_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `fx21p_content_types`
--

CREATE TABLE IF NOT EXISTS `fx21p_content_types` (
...
--
-- Dumping data for table `fx21p_content_types`
--

INSERT INTO `fx21p_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
--
-- Table structure for table `fx21p_core_log_searches`
--

CREATE TABLE IF NOT EXISTS `fx21p_core_log_searches` (
...
--
-- Table structure for table `fx21p_extensions`
--

CREATE TABLE IF NOT EXISTS `fx21p_extensions` (
...
--
-- Dumping data for table `fx21p_extensions`
--

INSERT INTO `fx21p_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(103, 'LIB_JOOMLA', 'library', 'joomla', '', 0, 1, 1, 1, '{"name":"LIB_JOOMLA","type":"library","creationDate":"2008","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2016 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"https:\\/\\/www.joomla.org","version":"13.1","description":"LIB_JOOMLA_XML_DESCRIPTION","group":"","filename":"joomla"}', '{"mediaversion":"aedec84e6340f8a43b39b5c655f49105"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(452, 'plg_system_updatenotification', 'plugin', 'updatenotification', 'system', 0, 1, 1, 0, '{"name":"plg_system_updatenotification","type":"plugin","creationDate":"May 2015","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2016 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"3.5.0","description":"PLG_SYSTEM_UPDATENOTIFICATION_XML_DESCRIPTION","group":"","filename":"updatenotification"}', '{"lastrun":1486494463}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(454, 'plg_system_stats', 'plugin', 'stats', 'system', 0, 1, 1, 0, '{"name":"plg_system_stats","type":"plugin","creationDate":"November 2013","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2016 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"3.5.0","description":"PLG_SYSTEM_STATS_XML_DESCRIPTION","group":"","filename":"stats"}', '{"mode":3,"lastrun":1486319541,"unique_id":"5925c2067a7a41e7521e8316ffb343cd098c3145","interval":12}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(10000, 'com_torshop', 'component', 'com_torshop', '', 1, 1, 0, 0, '{"name":"com_torshop","type":"component","creationDate":"February 2017","author":"Tormix","copyright":"Copyright 2010 - 2017. All rights reserved [Generated by SMT JGenerator]","authorEmail":"support@tormix.com","authorUrl":"http:\\/\\/tormix.com","version":"1.0.0","description":"TorShop - a simple powerfull native Joomla E-commerce component for create online shop.","group":"","filename":"torshop"}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10001, 'com_tortags', 'component', 'com_tortags', '', 1, 1, 0, 0, '{"name":"com_tortags","type":"component","creationDate":"November 2012","author":"Tormix Team","copyright":"Copyright 2010 - 2016. All rights reserved","authorEmail":"support@tormix.com","authorUrl":"http:\\/\\/tormix.com","version":"3.2.2","description":"","group":"","filename":"tortags"}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `fx21p_finder_filters`
--

CREATE TABLE IF NOT EXISTS `fx21p_finder_filters` (
...
--
-- Table structure for table `fx21p_finder_links`
--

CREATE TABLE IF NOT EXISTS `fx21p_finder_links` (
...
--
-- Table structure for table `fx21p_finder_links_terms0`
--

CREATE TABLE IF NOT EXISTS `fx21p_finder_links_terms0` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `fx21p_finder_links_terms1`
--

CREATE TABLE IF NOT EXISTS `fx21p_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `fx21p_finder_links_terms2`
--

CREATE TABLE IF NOT EXISTS `fx21p_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `fx21p_finder_links_terms3`
--

CREATE TABLE IF NOT EXISTS `fx21p_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `fx21p_finder_links_terms4`
--

CREATE TABLE IF NOT EXISTS `fx21p_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `fx21p_finder_links_terms5`
--

CREATE TABLE IF NOT EXISTS `fx21p_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `fx21p_finder_links_terms6`
--

CREATE TABLE IF NOT EXISTS `fx21p_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `fx21p_finder_links_terms7`
--

CREATE TABLE IF NOT EXISTS `fx21p_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `fx21p_finder_links_terms8`
--

CREATE TABLE IF NOT EXISTS `fx21p_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `fx21p_finder_links_terms9`
--

CREATE TABLE IF NOT EXISTS `fx21p_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `fx21p_finder_links_termsa`
--

CREATE TABLE IF NOT EXISTS `fx21p_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `fx21p_finder_links_termsb`
--

CREATE TABLE IF NOT EXISTS `fx21p_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `fx21p_finder_links_termsc`
--

CREATE TABLE IF NOT EXISTS `fx21p_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `fx21p_finder_links_termsd`
--

CREATE TABLE IF NOT EXISTS `fx21p_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `fx21p_finder_links_termse`
--

CREATE TABLE IF NOT EXISTS `fx21p_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `fx21p_finder_links_termsf`
--

CREATE TABLE IF NOT EXISTS `fx21p_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `fx21p_finder_taxonomy`
--

CREATE TABLE IF NOT EXISTS `fx21p_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Dumping data for table `fx21p_finder_taxonomy`
--

INSERT INTO `fx21p_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `fx21p_finder_taxonomy_map`
--

CREATE TABLE IF NOT EXISTS `fx21p_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `fx21p_finder_terms`
--

CREATE TABLE IF NOT EXISTS `fx21p_finder_terms` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `fx21p_finder_terms_common`
--

CREATE TABLE IF NOT EXISTS `fx21p_finder_terms_common` (
  `term` varchar(75) NOT NULL,
  `language` varchar(3) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `fx21p_finder_terms_common`
--

INSERT INTO `fx21p_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Table structure for table `fx21p_finder_tokens`
--

CREATE TABLE IF NOT EXISTS `fx21p_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `fx21p_finder_tokens_aggregate`
--

CREATE TABLE IF NOT EXISTS `fx21p_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `fx21p_finder_types`
--

CREATE TABLE IF NOT EXISTS `fx21p_finder_types` (
  `id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `fx21p_languages`
--

CREATE TABLE IF NOT EXISTS `fx21p_languages` (
...
--
-- Dumping data for table `fx21p_languages`
--

INSERT INTO `fx21p_languages` (`lang_id`, `asset_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 0, 'en-GB', 'English (UK)', 'English (UK)', 'en', 'en_gb', '', '', '', '', 1, 1, 1);

-- --------------------------------------------------------

--
-- Table structure for table `fx21p_menu`
--

CREATE TABLE IF NOT EXISTS `fx21p_menu` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `fx21p_menu`
--

INSERT INTO `fx21p_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
(102, 'main', 'com_torshop', 'com-torshop', '', 'com-torshop', 'index.php?option=com_torshop', 'component', 0, 1, 1, 10000, 0, '0000-00-00 00:00:00', 0, 1, 'class:component', 0, '{}', 43, 44, 0, '', 1),
(103, 'main', 'COM_TORTAGS_MENU', 'com-tortags-menu', '', 'com-tortags-menu', 'index.php?option=com_tortags', 'component', 0, 1, 1, 10001, 0, '0000-00-00 00:00:00', 0, 1, '../media/com_tortags/images/tormix-16.png', 0, '{}', 45, 56, 0, '', 1),
(104, 'main', 'COM_TORTAGS_MENU_COMOPONENTS', 'com-tortags-menu-comoponents', '', 'com-tortags-menu/com-tortags-menu-comoponents', 'index.php?option=com_tortags&view=components', 'component', 0, 103, 2, 10001, 0, '0000-00-00 00:00:00', 0, 1, 'components/com_tortags/assets/images/components.png', 0, '{}', 46, 47, 0, '', 1),
(105, 'main', 'COM_TORTAGS_MENU_TAGS', 'com-tortags-menu-tags', '', 'com-tortags-menu/com-tortags-menu-tags', 'index.php?option=com_tortags&view=tags', 'component', 0, 103, 2, 10001, 0, '0000-00-00 00:00:00', 0, 1, 'components/com_tortags/assets/images/tags.png', 0, '{}', 48, 49, 0, '', 1),
(106, 'main', 'COM_TORTAGS_MENU_IMPEX', 'com-tortags-menu-impex', '', 'com-tortags-menu/com-tortags-menu-impex', 'index.php?option=com_tortags&view=impexp', 'component', 0, 103, 2, 10001, 0, '0000-00-00 00:00:00', 0, 1, 'components/com_tortags/assets/images/import.png', 0, '{}', 50, 51, 0, '', 1),
(107, 'main', 'COM_TORTAGS_MENU_SETTINGS', 'com-tortags-menu-settings', '', 'com-tortags-menu/com-tortags-menu-settings', 'index.php?option=com_tortags&view=settings', 'component', 0, 103, 2, 10001, 0, '0000-00-00 00:00:00', 0, 1, 'components/com_tortags/assets/images/settings.png', 0, '{}', 52, 53, 0, '', 1),
(108, 'main', 'COM_TORTAGS_MENU_ABOUT', 'com-tortags-menu-about', '', 'com-tortags-menu/com-tortags-menu-about', 'index.php?option=com_tortags&view=about', 'component', 0, 103, 2, 10001, 0, '0000-00-00 00:00:00', 0, 1, 'components/com_tortags/assets/images/about.png', 0, '{}', 54, 55, 0, '', 1);

-- --------------------------------------------------------

--
-- Table structure for table `fx21p_menu_types`
--

CREATE TABLE IF NOT EXISTS `fx21p_menu_types` (
  `id` int(10) unsigned NOT NULL,
  `asset_id` int(11) NOT NULL,
...
--
-- Dumping data for table `fx21p_menu_types`
--

INSERT INTO `fx21p_menu_types` (`id`, `asset_id`, `menutype`, `title`, `description`) VALUES
(1, 0, 'mainmenu', 'Main Menu', 'The main menu for the site');

-- --------------------------------------------------------

--
-- Table structure for table `fx21p_messages`
--

CREATE TABLE IF NOT EXISTS `fx21p_messages` (
...
--
-- Table structure for table `fx21p_messages_cfg`
--

CREATE TABLE IF NOT EXISTS `fx21p_messages_cfg` (
...
--
-- Table structure for table `fx21p_modules`
--

CREATE TABLE IF NOT EXISTS `fx21p_modules` (
  `id` int(11) NOT NULL,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
...
--
-- Dumping data for table `fx21p_modules`
--

INSERT INTO `fx21p_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
--
-- Table structure for table `fx21p_modules_menu`
--

CREATE TABLE IF NOT EXISTS `fx21p_modules_menu` (
  `moduleid` int(11) NOT NULL DEFAULT '0',
  `menuid` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `fx21p_modules_menu`
--

INSERT INTO `fx21p_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Table structure for table `fx21p_newsfeeds`
--

CREATE TABLE IF NOT EXISTS `fx21p_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `fx21p_overrider`
--

CREATE TABLE IF NOT EXISTS `fx21p_overrider` (
...
--
-- Table structure for table `fx21p_postinstall_messages`
--

CREATE TABLE IF NOT EXISTS `fx21p_postinstall_messages` (
...
--
-- Dumping data for table `fx21p_postinstall_messages`
--

INSERT INTO `fx21p_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
--
-- Table structure for table `fx21p_redirect_links`
--

CREATE TABLE IF NOT EXISTS `fx21p_redirect_links` (
  `id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `fx21p_schemas`
--

CREATE TABLE IF NOT EXISTS `fx21p_schemas` (
  `extension_id` int(11) NOT NULL,
  `version_id` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `fx21p_schemas`
--

INSERT INTO `fx21p_schemas` (`extension_id`, `version_id`) VALUES
(700, '3.6.3-2016-08-16');

-- --------------------------------------------------------

--
-- Table structure for table `fx21p_session`
--

CREATE TABLE IF NOT EXISTS `fx21p_session` (
...
--
-- Dumping data for table `fx21p_session`
--

INSERT INTO `fx21p_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
('t8s21hljuuqajnqrhl700q15e7', 1, 0, '1486503615', 'joomla|s:1708:"";', 335, 'admin');

-- --------------------------------------------------------

--
-- Table structure for table `fx21p_tags`
--

CREATE TABLE IF NOT EXISTS `fx21p_tags` (
  `id` int(10) unsigned NOT NULL,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
  `rgt` int(11) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `fx21p_tags`
--

INSERT INTO `fx21p_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
(1, 0, 0, 1, 0, '', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '', '', '', '', 335, '2011-01-01 00:00:01', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Table structure for table `fx21p_template_styles`
--

CREATE TABLE IF NOT EXISTS `fx21p_template_styles` (
  `id` int(10) unsigned NOT NULL,
...
--
-- Dumping data for table `fx21p_template_styles`
--

INSERT INTO `fx21p_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
...
--
-- Table structure for table `fx21p_torshop_categories`
--

CREATE TABLE IF NOT EXISTS `fx21p_torshop_categories` (
  `id` int(10) unsigned NOT NULL COMMENT 'id',
  `title` varchar(250) NOT NULL COMMENT 'Title of category',
  `alias` varchar(250) NOT NULL COMMENT 'Alias of category',
  `description` text NOT NULL COMMENT 'Alias of category',
  `published` int(4) NOT NULL DEFAULT '0'
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='Table of shop categories';

--
-- Dumping data for table `fx21p_torshop_categories`
--

INSERT INTO `fx21p_torshop_categories` (`id`, `title`, `alias`, `description`, `published`) VALUES
(1, 'Computers', 'computers', '<p>A <strong>computer is a device</strong> that can be instructed to carry out an arbitrary set of arithmetic or logical operations automatically.</p>\r\n<p>The ability of computers to follow a sequence of operations, <strong>called a program</strong>, make computers very applicable to a wide range of tasks. Such computers are used as control systems for a very wide variety of industrial and consumer devices. This includes simple special purpose devices like microwave ovens and remote controls, factory devices such as industrial robots and computer assisted design, but also in general purpose devices like personal computers and mobile devices such as smartphones.</p>\r\n<p>The <em>Internet is run</em> on computers and it connects millions of other computers.</p>', 1),
(2, 'Phones', 'phones', 'The telephone, or phone was developed in 1876 by Alexander Graham Bell. and improved by many other inventors. Telephones rapidly became common in advanced societies.\r\n\r\nThe essential elements of a telephone are a microphone (transmitter) to speak into and an earphone (receiver) which reproduces the voice in a distant location. In addition, most telephones contain a ringer which produces a sound to announce an incoming telephone call, and a dial or keypad used to enter a telephone number when initiating a call to another telephone. Until approximately the 1970s most telephones used a rotary dial, which was superseded by the modern DTMF push-button dial, first introduced to the public by AT&T in 1963.[1] The receiver and transmitter are usually built into a handset which is held up to the ear and mouth during conversation. The dial may be located either on the handset, or on a base unit to which the handset is connected. The transmitter converts the sound waves to electrical signals which are sent through the telephone network to the receiving phone. The receiving telephone converts the signals into audible sound in the receiver, or sometimes a loudspeaker. Telephones permit duplex communication, meaning they allow the people on both ends to talk simultaneously.', 1);

-- --------------------------------------------------------

--
-- Table structure for table `fx21p_tortags`
--

CREATE TABLE IF NOT EXISTS `fx21p_tortags` (
  `id` int(10) unsigned NOT NULL COMMENT 'id',
...
--
-- Table structure for table `fx21p_tortags_categories`
--

CREATE TABLE IF NOT EXISTS `fx21p_tortags_categories` (
  `id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `fx21p_tortags_cat_xref`
--

CREATE TABLE IF NOT EXISTS `fx21p_tortags_cat_xref` (
  `id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `fx21p_tortags_components`
--

CREATE TABLE IF NOT EXISTS `fx21p_tortags_components` (
  `id` int(10) unsigned NOT NULL COMMENT 'id',
  ...
  `state_field` varchar(150) NOT NULL COMMENT 'State field',
  `state_status` varchar(150) NOT NULL COMMENT 'State status value',
  `be_key` varchar(100) NOT NULL COMMENT 'Back End key',
  `fe_key` varchar(100) NOT NULL COMMENT 'Front End key',
  `where_enable` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT 'where enable adding',
  `def_lang` varchar(20) NOT NULL COMMENT 'language for component',
  `exc_views` text NOT NULL COMMENT 'Exceptions of views'
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='Table of components';

--
-- Dumping data for table `fx21p_tortags_components`
--

INSERT INTO `fx21p_tortags_components` (`id`, `component`, `table`, `id_field`, `title_field`, `description_field`, `created_field`, `url_template`, `state_field`, `state_status`, `be_key`, `fe_key`, `where_enable`, `def_lang`, `exc_views`) VALUES
...
--
-- Table structure for table `fx21p_tortags_tags`
--

CREATE TABLE IF NOT EXISTS `fx21p_tortags_tags` (
  `id` int(10) unsigned NOT NULL COMMENT 'tag id',
  `title` varchar(200) NOT NULL COMMENT 'tag title',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '' COMMENT 'alias for tag',
  `language` char(7) NOT NULL DEFAULT '*' COMMENT 'The language code for the tag',
  `published` tinyint(3) NOT NULL DEFAULT '1' COMMENT 'Publish status',
  `catid` varchar(255) NOT NULL COMMENT 'Category id(s)',
  `description` text NOT NULL COMMENT 'tag description',
...
--
-- Table structure for table `fx21p_ucm_base`
--

CREATE TABLE IF NOT EXISTS `fx21p_ucm_base` (
...
--
-- Table structure for table `fx21p_ucm_content`
--

CREATE TABLE IF NOT EXISTS `fx21p_ucm_content` (
...
--
-- Table structure for table `fx21p_ucm_history`
--

CREATE TABLE IF NOT EXISTS `fx21p_ucm_history` (
...
--
-- Table structure for table `fx21p_updates`
--

CREATE TABLE IF NOT EXISTS `fx21p_updates` (
...
--
-- Dumping data for table `fx21p_updates`
--

INSERT INTO `fx21p_updates` (`update_id`, `update_site_id`, `extension_id`, `name`, `description`, `element`, `type`, `folder`, `client_id`, `version`, `data`, `detailsurl`, `infourl`, `extra_query`) VALUES
...
(31, 3, 0, 'Persian', '', 'pkg_fa-IR', 'package', '', 0, '3.6.5.1', '', 'https://update.joomla.org/language/details3/fa-IR_details.xml', '', ''),
...
--
-- Table structure for table `fx21p_update_sites`
--

CREATE TABLE IF NOT EXISTS `fx21p_update_sites` (
...
--
-- Dumping data for table `fx21p_update_sites`
--

INSERT INTO `fx21p_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
(1, 'Joomla! Core', 'collection', 'https://update.joomla.org/core/list.xml', 1, 1486494464, ''),
(2, 'Joomla! Extension Directory', 'collection', 'https://update.joomla.org/jed/list.xml', 1, 1486494465, ''),
(3, 'Accredited Joomla! Translations', 'collection', 'https://update.joomla.org/language/translationlist_3.xml', 1, 1486405905, ''),
(4, 'Joomla! Update Component Update Site', 'extension', 'https://update.joomla.org/core/extensions/com_joomlaupdate.xml', 1, 1486405907, '');

-- --------------------------------------------------------

--
-- Table structure for table `fx21p_update_sites_extensions`
--

CREATE TABLE IF NOT EXISTS `fx21p_update_sites_extensions` (
  `update_site_id` int(11) NOT NULL DEFAULT '0',
  `extension_id` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Links extensions to update sites';

--
-- Dumping data for table `fx21p_update_sites_extensions`
--

INSERT INTO `fx21p_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 802),
(4, 28);
...
--
-- Table structure for table `fx21p_usergroups`
--

CREATE TABLE IF NOT EXISTS `fx21p_usergroups` (
  `id` int(10) unsigned NOT NULL COMMENT 'Primary Key',
...
--
-- Dumping data for table `fx21p_usergroups`
--

INSERT INTO `fx21p_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Table structure for table `fx21p_users`
--

CREATE TABLE IF NOT EXISTS `fx21p_users` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `fx21p_users`
--

INSERT INTO `fx21p_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`, `requireReset`) VALUES
(335, 'Super User', 'admin', 'jtmp@ya.ru', '$2y$10$JvmFRJElIHfmZcscv40dcut6zxQo.aJw48ehtFzK5v6AsoYgsXC0G', 0, 1, '2017-02-05 18:31:40', '2017-02-07 19:54:23', '0', '', '0000-00-00 00:00:00', 0, '', '', 0);

-- --------------------------------------------------------

--
-- Table structure for table `fx21p_user_keys`
--

CREATE TABLE IF NOT EXISTS `fx21p_user_keys` (
  `id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `fx21p_user_notes`
--

CREATE TABLE IF NOT EXISTS `fx21p_user_notes` (
  `id` int(10) unsigned NOT NULL,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `fx21p_user_profiles`
--

CREATE TABLE IF NOT EXISTS `fx21p_user_profiles` (
...
--
-- Table structure for table `fx21p_user_usergroup_map`
--

CREATE TABLE IF NOT EXISTS `fx21p_user_usergroup_map` (
  `user_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__users.id',
  `group_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__usergroups.id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `fx21p_user_usergroup_map`
--

INSERT INTO `fx21p_user_usergroup_map` (`user_id`, `group_id`) VALUES
(335, 8);

-- --------------------------------------------------------

--
-- Table structure for table `fx21p_utf8_conversion`
--

CREATE TABLE IF NOT EXISTS `fx21p_utf8_conversion` (
  `converted` tinyint(4) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `fx21p_utf8_conversion`
--

INSERT INTO `fx21p_utf8_conversion` (`converted`) VALUES
(2);

-- --------------------------------------------------------

--
-- Table structure for table `fx21p_viewlevels`
--

CREATE TABLE IF NOT EXISTS `fx21p_viewlevels` (
  `id` int(10) unsigned NOT NULL COMMENT 'Primary Key',
  `title` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'JSON encoded access control.'
...
--
-- Dumping data for table `fx21p_viewlevels`
--

INSERT INTO `fx21p_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
--
-- Indexes for table `fx21p_assets`
--
ALTER TABLE `fx21p_assets`
  ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `idx_asset_name` (`name`), ADD KEY `idx_lft_rgt` (`lft`,`rgt`), ADD KEY `idx_parent_id` (`parent_id`);

--
-- Indexes for table `fx21p_associations`
--
ALTER TABLE `fx21p_associations`
  ADD PRIMARY KEY (`context`,`id`), ADD KEY `idx_key` (`key`);

--
-- Indexes for table `fx21p_banners`
--
ALTER TABLE `fx21p_banners`
...
--
-- Indexes for table `fx21p_banner_clients`
--
ALTER TABLE `fx21p_banner_clients`
  ADD PRIMARY KEY (`id`), ADD KEY `idx_own_prefix` (`own_prefix`), ADD KEY `idx_metakey_prefix` (`metakey_prefix`(100));

--
-- Indexes for table `fx21p_banner_tracks`
--
ALTER TABLE `fx21p_banner_tracks`
...
--
-- Indexes for table `fx21p_categories`
--
ALTER TABLE `fx21p_categories`
...
--
-- Indexes for table `fx21p_contact_details`
--
ALTER TABLE `fx21p_contact_details`
...
--
-- Indexes for table `fx21p_content`
--
ALTER TABLE `fx21p_content`
...
--
-- Indexes for table `fx21p_contentitem_tag_map`
--
ALTER TABLE `fx21p_contentitem_tag_map`
...
--
-- Indexes for table `fx21p_content_frontpage`
--
ALTER TABLE `fx21p_content_frontpage`
  ADD PRIMARY KEY (`content_id`);

--
-- Indexes for table `fx21p_content_rating`
--
ALTER TABLE `fx21p_content_rating`
  ADD PRIMARY KEY (`content_id`);

--
-- Indexes for table `fx21p_content_types`
--
ALTER TABLE `fx21p_content_types`
  ADD PRIMARY KEY (`type_id`), ADD KEY `idx_alias` (`type_alias`(100));

--
-- Indexes for table `fx21p_extensions`
--
ALTER TABLE `fx21p_extensions`
...
--
-- Indexes for table `fx21p_finder_filters`
--
ALTER TABLE `fx21p_finder_filters`
  ADD PRIMARY KEY (`filter_id`);

--
-- Indexes for table `fx21p_finder_links`
--
ALTER TABLE `fx21p_finder_links`
...
--
-- Indexes for table `fx21p_finder_links_terms0`
--
ALTER TABLE `fx21p_finder_links_terms0`
...
--
-- Indexes for table `fx21p_finder_links_terms1`
--
ALTER TABLE `fx21p_finder_links_terms1`
  ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `fx21p_finder_links_terms2`
--
ALTER TABLE `fx21p_finder_links_terms2`
  ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `fx21p_finder_links_terms3`
--
ALTER TABLE `fx21p_finder_links_terms3`
  ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `fx21p_finder_links_terms4`
--
ALTER TABLE `fx21p_finder_links_terms4`
  ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `fx21p_finder_links_terms5`
--
ALTER TABLE `fx21p_finder_links_terms5`
  ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `fx21p_finder_links_terms6`
--
ALTER TABLE `fx21p_finder_links_terms6`
  ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `fx21p_finder_links_terms7`
--
ALTER TABLE `fx21p_finder_links_terms7`
  ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `fx21p_finder_links_terms8`
--
ALTER TABLE `fx21p_finder_links_terms8`
  ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `fx21p_finder_links_terms9`
--
ALTER TABLE `fx21p_finder_links_terms9`
  ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `fx21p_finder_links_termsa`
--
ALTER TABLE `fx21p_finder_links_termsa`
  ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `fx21p_finder_links_termsb`
--
ALTER TABLE `fx21p_finder_links_termsb`
  ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `fx21p_finder_links_termsc`
--
ALTER TABLE `fx21p_finder_links_termsc`
  ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `fx21p_finder_links_termsd`
--
ALTER TABLE `fx21p_finder_links_termsd`
  ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `fx21p_finder_links_termse`
--
ALTER TABLE `fx21p_finder_links_termse`
  ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `fx21p_finder_links_termsf`
--
ALTER TABLE `fx21p_finder_links_termsf`
  ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `fx21p_finder_taxonomy`
--
ALTER TABLE `fx21p_finder_taxonomy`
...
--
-- Indexes for table `fx21p_finder_taxonomy_map`
--
ALTER TABLE `fx21p_finder_taxonomy_map`
  ADD PRIMARY KEY (`link_id`,`node_id`), ADD KEY `link_id` (`link_id`), ADD KEY `node_id` (`node_id`);

--
-- Indexes for table `fx21p_finder_terms`
--
ALTER TABLE `fx21p_finder_terms`
...
--
-- Indexes for table `fx21p_finder_terms_common`
--
ALTER TABLE `fx21p_finder_terms_common`
  ADD KEY `idx_word_lang` (`term`,`language`), ADD KEY `idx_lang` (`language`);

--
-- Indexes for table `fx21p_finder_tokens`
--
ALTER TABLE `fx21p_finder_tokens`
  ADD KEY `idx_word` (`term`), ADD KEY `idx_context` (`context`);

--
-- Indexes for table `fx21p_finder_tokens_aggregate`
--
ALTER TABLE `fx21p_finder_tokens_aggregate`
  ADD KEY `token` (`term`), ADD KEY `keyword_id` (`term_id`);

--
-- Indexes for table `fx21p_finder_types`
--
ALTER TABLE `fx21p_finder_types`
  ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `title` (`title`);

--
-- Indexes for table `fx21p_languages`
--
ALTER TABLE `fx21p_languages`
...
--
-- Indexes for table `fx21p_menu`
--
ALTER TABLE `fx21p_menu`
...
--
-- Indexes for table `fx21p_menu_types`
--
ALTER TABLE `fx21p_menu_types`
  ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `idx_menutype` (`menutype`);

--
-- Indexes for table `fx21p_messages`
--
ALTER TABLE `fx21p_messages`
  ADD PRIMARY KEY (`message_id`), ADD KEY `useridto_state` (`user_id_to`,`state`);

--
-- Indexes for table `fx21p_messages_cfg`
--
ALTER TABLE `fx21p_messages_cfg`
  ADD UNIQUE KEY `idx_user_var_name` (`user_id`,`cfg_name`);

--
-- Indexes for table `fx21p_modules`
--
ALTER TABLE `fx21p_modules`
  ADD PRIMARY KEY (`id`), ADD KEY `published` (`published`,`access`), ADD KEY `newsfeeds` (`module`,`published`), ADD KEY `idx_language` (`language`);

--
-- Indexes for table `fx21p_modules_menu`
--
ALTER TABLE `fx21p_modules_menu`
  ADD PRIMARY KEY (`moduleid`,`menuid`);

--
-- Indexes for table `fx21p_newsfeeds`
--
ALTER TABLE `fx21p_newsfeeds`
...
--
-- Indexes for table `fx21p_overrider`
--
ALTER TABLE `fx21p_overrider`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `fx21p_postinstall_messages`
--
ALTER TABLE `fx21p_postinstall_messages`
  ADD PRIMARY KEY (`postinstall_message_id`);

--
-- Indexes for table `fx21p_redirect_links`
--
ALTER TABLE `fx21p_redirect_links`
  ADD PRIMARY KEY (`id`), ADD KEY `idx_old_url` (`old_url`(100)), ADD KEY `idx_link_modifed` (`modified_date`);

--
-- Indexes for table `fx21p_schemas`
--
ALTER TABLE `fx21p_schemas`
  ADD PRIMARY KEY (`extension_id`,`version_id`);

--
-- Indexes for table `fx21p_session`
--
ALTER TABLE `fx21p_session`
  ADD PRIMARY KEY (`session_id`), ADD KEY `userid` (`userid`), ADD KEY `time` (`time`);

--
-- Indexes for table `fx21p_tags`
--
ALTER TABLE `fx21p_tags`
...
--
-- Indexes for table `fx21p_template_styles`
--
ALTER TABLE `fx21p_template_styles`
  ADD PRIMARY KEY (`id`), ADD KEY `idx_template` (`template`), ADD KEY `idx_home` (`home`);

--
-- Indexes for table `fx21p_torshop_categories`
--
ALTER TABLE `fx21p_torshop_categories`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `fx21p_tortags`
--
ALTER TABLE `fx21p_tortags`
  ADD PRIMARY KEY (`id`), ADD KEY `super_tags_idx` (`tid`,`oid`,`item_id`) COMMENT 'Super tags index', ADD KEY `tagid_idx` (`tid`) COMMENT 'Tag ID index', ADD KEY `oid_idx` (`oid`) COMMENT 'Component ID index', ADD KEY `itemid_idx` (`item_id`) COMMENT 'Item ID index';

--
-- Indexes for table `fx21p_tortags_categories`
--
ALTER TABLE `fx21p_tortags_categories`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `fx21p_tortags_cat_xref`
--
ALTER TABLE `fx21p_tortags_cat_xref`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `fx21p_tortags_components`
--
ALTER TABLE `fx21p_tortags_components`
  ADD PRIMARY KEY (`id`), ADD KEY `component_idx` (`component`) COMMENT 'Component index';

--
-- Indexes for table `fx21p_tortags_tags`
--
ALTER TABLE `fx21p_tortags_tags`
  ADD PRIMARY KEY (`id`), ADD KEY `tag_title_idx` (`title`) COMMENT 'Title index', ADD KEY `tag_title_plus_pulished_idx` (`title`,`published`) COMMENT 'Title plus published index', ADD KEY `hits_idx` (`hits`) COMMENT 'Hits index';

--
-- Indexes for table `fx21p_ucm_base`
--
ALTER TABLE `fx21p_ucm_base`
...
--
-- Indexes for table `fx21p_ucm_content`
--
ALTER TABLE `fx21p_ucm_content`
...
--
-- Indexes for table `fx21p_ucm_history`
--
ALTER TABLE `fx21p_ucm_history`
  ADD PRIMARY KEY (`version_id`), ADD KEY `idx_ucm_item_id` (`ucm_type_id`,`ucm_item_id`), ADD KEY `idx_save_date` (`save_date`);

--
-- Indexes for table `fx21p_updates`
--
ALTER TABLE `fx21p_updates`
  ADD PRIMARY KEY (`update_id`);

--
-- Indexes for table `fx21p_update_sites`
--
ALTER TABLE `fx21p_update_sites`
  ADD PRIMARY KEY (`update_site_id`);

--
-- Indexes for table `fx21p_update_sites_extensions`
--
ALTER TABLE `fx21p_update_sites_extensions`
  ADD PRIMARY KEY (`update_site_id`,`extension_id`);

--
-- Indexes for table `fx21p_usergroups`
--
ALTER TABLE `fx21p_usergroups`
...
--
-- Indexes for table `fx21p_user_notes`
--
ALTER TABLE `fx21p_user_notes`
  ADD PRIMARY KEY (`id`), ADD KEY `idx_user_id` (`user_id`), ADD KEY `idx_category_id` (`catid`);

--
-- Indexes for table `fx21p_user_profiles`
--
ALTER TABLE `fx21p_user_profiles`
  ADD UNIQUE KEY `idx_user_id_profile_key` (`user_id`,`profile_key`);

--
-- Indexes for table `fx21p_user_usergroup_map`
--
ALTER TABLE `fx21p_user_usergroup_map`
  ADD PRIMARY KEY (`user_id`,`group_id`);

--
-- Indexes for table `fx21p_viewlevels`
--
ALTER TABLE `fx21p_viewlevels`
...
--
-- AUTO_INCREMENT for table `fx21p_assets`
--
ALTER TABLE `fx21p_assets`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',AUTO_INCREMENT=57;
--
-- AUTO_INCREMENT for table `fx21p_banners`
--
ALTER TABLE `fx21p_banners`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `fx21p_banner_clients`
--
ALTER TABLE `fx21p_banner_clients`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `fx21p_categories`
--
ALTER TABLE `fx21p_categories`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT for table `fx21p_contact_details`
--
ALTER TABLE `fx21p_contact_details`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `fx21p_content`
--
ALTER TABLE `fx21p_content`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `fx21p_content_types`
--
ALTER TABLE `fx21p_content_types`
  MODIFY `type_id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=14;
--
-- AUTO_INCREMENT for table `fx21p_extensions`
--
ALTER TABLE `fx21p_extensions`
  MODIFY `extension_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=10002;
--
-- AUTO_INCREMENT for table `fx21p_finder_filters`
--
ALTER TABLE `fx21p_finder_filters`
  MODIFY `filter_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `fx21p_finder_links`
--
ALTER TABLE `fx21p_finder_links`
  MODIFY `link_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `fx21p_finder_taxonomy`
--
ALTER TABLE `fx21p_finder_taxonomy`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `fx21p_finder_terms`
--
ALTER TABLE `fx21p_finder_terms`
  MODIFY `term_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `fx21p_finder_types`
--
ALTER TABLE `fx21p_finder_types`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `fx21p_languages`
--
ALTER TABLE `fx21p_languages`
  MODIFY `lang_id` int(11) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `fx21p_menu`
--
ALTER TABLE `fx21p_menu`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=109;
--
-- AUTO_INCREMENT for table `fx21p_menu_types`
--
ALTER TABLE `fx21p_menu_types`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `fx21p_messages`
--
ALTER TABLE `fx21p_messages`
  MODIFY `message_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `fx21p_modules`
--
ALTER TABLE `fx21p_modules`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=87;
--
-- AUTO_INCREMENT for table `fx21p_newsfeeds`
--
ALTER TABLE `fx21p_newsfeeds`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `fx21p_overrider`
--
ALTER TABLE `fx21p_overrider`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'Primary Key';
--
-- AUTO_INCREMENT for table `fx21p_postinstall_messages`
--
ALTER TABLE `fx21p_postinstall_messages`
  MODIFY `postinstall_message_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `fx21p_redirect_links`
--
ALTER TABLE `fx21p_redirect_links`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `fx21p_tags`
--
ALTER TABLE `fx21p_tags`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `fx21p_template_styles`
--
ALTER TABLE `fx21p_template_styles`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT for table `fx21p_torshop_categories`
--
ALTER TABLE `fx21p_torshop_categories`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'id',AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `fx21p_tortags`
--
ALTER TABLE `fx21p_tortags`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'id';
--
-- AUTO_INCREMENT for table `fx21p_tortags_categories`
--
ALTER TABLE `fx21p_tortags_categories`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `fx21p_tortags_cat_xref`
--
ALTER TABLE `fx21p_tortags_cat_xref`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `fx21p_tortags_components`
--
ALTER TABLE `fx21p_tortags_components`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'id',AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `fx21p_tortags_tags`
--
ALTER TABLE `fx21p_tortags_tags`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'tag id';
--
-- AUTO_INCREMENT for table `fx21p_ucm_content`
--
ALTER TABLE `fx21p_ucm_content`
  MODIFY `core_content_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `fx21p_ucm_history`
--
ALTER TABLE `fx21p_ucm_history`
  MODIFY `version_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `fx21p_updates`
--
ALTER TABLE `fx21p_updates`
  MODIFY `update_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=74;
--
-- AUTO_INCREMENT for table `fx21p_update_sites`
--
ALTER TABLE `fx21p_update_sites`
  MODIFY `update_site_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `fx21p_usergroups`
--
ALTER TABLE `fx21p_usergroups`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT for table `fx21p_users`
--
ALTER TABLE `fx21p_users`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=336;
--
-- AUTO_INCREMENT for table `fx21p_user_keys`
--
ALTER TABLE `fx21p_user_keys`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `fx21p_user_notes`
--
ALTER TABLE `fx21p_user_notes`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `fx21p_viewlevels`
--
ALTER TABLE `fx21p_viewlevels`
