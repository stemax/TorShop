...
$search = $this->escape($this->state->get('filter.search_order'));
?>
            <form action="<?php echo JRoute::_('index.php?option=com_torshop&view=orders'); ?>" method="post"
                ...
                <div id="j-main-container" class="span10">
                    ...
                    <div id="filter-bar" class="btn-toolbar">
                        <div class="filter-search btn-group pull-left">
                            <label for="filter_search_order"
                                   class="element-invisible"><?php echo JText::_('JSEARCH_FILTER_LABEL'); ?></label>
                            <input type="text" name="filter_search_order" id="filter_search_order"
                                   placeholder="<?php echo JText::_('JSEARCH_FILTER_LABEL'); ?>"
                                   value="<?php echo $this->escape($this->state->get('filter.search_order')); ?>"
                        ...
                        <div class="btn-group pull-left">
                            ...
                            <button class="btn hasTooltip" type="button"
                                    title="<?php echo JText::_('JSEARCH_FILTER_CLEAR'); ?>" onclick="document.id('filter_search_order').value = '';
                        ...
                        if ($this->orders) {
                            foreach ($this->orders as $i => $item) {
                                ...
                                <tr class="row<?php echo $i % 2; ?>">
                                    ...
                                    <td>
                                        <img
                                            src="<?php echo JURI::root(); ?>administrator/components/com_torshop/assets/images/order.png"/>
                                        <?php if ($this->user->authorise('core.edit') or ($this->user->authorise('core.edit.own'))) { ?>
                                            <a href="<?php echo JRoute::_('index.php?option=com_torshop&task=order.edit&id=' . $item->id); ?>">
                                                <?php echo $item->id; ?>
                                            </a>
                                        <?php } else { ?>
                                            <?php echo $item->id;
