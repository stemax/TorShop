...
<table class="admin table table-striped" width="100%">
    ...
    <tr>
        <td valign="top" width="100%">
            <form action="<?php echo JRoute::_('index.php?option=com_tortags&view=cats'); ?>" method="post"
                  id="adminForm" name="adminForm">
                <?php if (TT_JVER != 3) { ?>
                    <fieldset id="filter-bar">
                        <div class="filter-search fltlft">
                            <label class="filter-search-lbl" for="filter_search_cat">
                            ...
                            <button type="button" onclick="document.id('filter_search_cat').value = '';
                                        this.form.submit();">
                ...
                <table class="adminlist table table-striped">
                    ...
                    <tr>
                        ...
                        <th>
                            <?php echo JHtml::_('grid.sort', 'COM_TORTAGS_CATNAME', '`c`.`catname`', $listDirn, $listOrder); ?>
                        </th>
                    ...
                    if ($this->cats) {
                        foreach ($this->cats as $i => $item) {
                            ...
                            <tr class="row<?php echo $i % 2; ?>">
                                ...
                                <td>
                                    <img
                                        src="<?php echo JURI::root(); ?>administrator/components/com_tortags/assets/images/cats.png"/>
                                    <?php if ($this->user->authorise('core.edit') or ($this->user->authorise('core.edit.own'))) { ?>
                                        <a href="<?php echo JRoute::_('index.php?option=com_tortags&task=cat.edit&id=' . $item->id); ?>">
                                    ...
                                    <div class="tt_tablcenter">
                                        <div class="button2-left">
                                            <div class="blank  btn btn-small">
                                                <a href="index.php?option=com_tortags&view=tags&filter_cid=<?php echo $item->id; ?>">
                                                    <img
                                                        src="<?php echo JURI::root(); ?>administrator/components/com_tortags/assets/images/tags.png"/>
                                                    <?php echo $item->tags_count; ?></a>&nbsp;
                                            </div>
                                        </div>
                                    </div>
                                </td>
